 ...
 *
 * Define low-level method used to interact with the database, intended to be used with dependency
 * injection in some wrapper class specific to a logical table in the database.
 */
interface Database {
  /**
