...
import ch.epfl.skysync.screens.inputValidation
    ...
    Column {
              ...
              DatePickerField(
                  ...
                  onclickConfirm = {
                    ...
                    Calendar.getInstance().apply {
                      ...
                      dateValue =
                          Instant.ofEpochMilli(timeInMillis).atZone(ZoneId.of("GMT")).toLocalDate()
                    }
                  },
      ...
      Button(
          ...
          onClick = {
            ...
            if (!isError) {
              val vehicles: List<Vehicle> = if (vehicle == null) emptyList() else listOf(vehicle!!)
...
fun DatePickerField(
  ...
  OutlinedTextField(
      modifier =
          Modifier.fillMaxWidth()
              .padding(bottom = defaultPadding, start = defaultPadding, end = defaultPadding)
...
private fun nbPassengerInputValidation(nbPassengersValue: String): Boolean {
  return nbPassengersValue.isEmpty() || nbPassengersValue.toInt() <= 0
}

private fun flightTypeInputValidation(flightTypeValue: FlightType?): Boolean {
