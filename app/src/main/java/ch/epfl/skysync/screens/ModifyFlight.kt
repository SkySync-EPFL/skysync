  ...
  Scaffold(
      ...
      topBar = {
        ...
        Column {
          ...
          var nbPassengersValue by remember { mutableStateOf(currentFlight.nPassengers.toString()) }
          var nbPassengersValueError by remember { mutableStateOf(false) }

          var openDatePicker by remember { mutableStateOf(false) }
          var dateValue by remember { mutableStateOf(currentFlight.date) }
          ...
          val listVehiclesValue = remember {
            mutableStateListOf(*currentFlight.vehicles.toTypedArray())
          }
          var addVehicle by remember { mutableStateOf(listVehiclesValue.isEmpty()) }

          var timeSlotValue: TimeSlot by remember { mutableStateOf(currentFlight.timeSlot) }
          ...
          val crewMembers = remember {
            mutableStateListOf(*currentFlight.team.roles.toTypedArray())
          }
