  ...
  private val repository = Repository(db)
    ...
    fun modifyAndDeleteFlight() {
        runTest {
            ...
            composeTestRule
                .onNodeWithText("Flight is loading...").assertDoesNotExist()
            composeTestRule
                .onNodeWithTag("Flight Lazy Column").assertExists()

            // Modifies flight details such as number of passengers, date, flight type, vehicle, time slot, balloon, and basket
