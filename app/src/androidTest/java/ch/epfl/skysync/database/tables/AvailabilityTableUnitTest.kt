...
class AvailabilityTableUnitTest {
    ...
    /**
     * Test the AvailabilityTable as one integration test
     * as it is mostly a wrapper of the FirestoreDatabase class (it has no relations)
     * and the FirestoreDatabase has no mock class, instead we use an emulator,
     * meaning we can not test the `add` method in isolation for example.
     */
    @Test
    fun integrationTest() {
